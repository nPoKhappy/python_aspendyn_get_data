...
#讀資料
    ...
    def disturbance(self, ram):        #gauss random disturbance
        ...
        print(f"F_CO2={Fn_carbon_dioxide:.2f}, F_H2O={Fn_hydrogen_dioxide:.2f}, F_H2S={Fn_hydrogen_sulfide:.2f}, T={inlet_T:.2f}, P={inlet_P:.4f}")
    ...
    def op(self, manual_time):
        op_TR2 = [random.gauss(190, 5) for _ in range(int(60 * 24 / manual_time))]  # user requested around 190
        op_air2 = [random.gauss(300, 10) for _ in range(int(60 * 24 / manual_time))]  # OOD: 明顯超出原本 air2 常見範圍
        print('op_TR2=', op_TR2)
